...
개요
    휴 모멘트의 값이 회전에 대해 같은 값을 유지한다는 것을 확인하였고,
    반사에 대해서는 7번째 성분의 부호가 반대로 된다는 것을 확인하였다.
"""
...
image_1 = cv2.imread("../data/shape_features.png")
image_2 = cv2.imread("../data/shape_features_rotation.png")
image_3 = cv2.imread("../data/shape_features_reflection.png")
